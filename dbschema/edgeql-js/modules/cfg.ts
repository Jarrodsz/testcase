...
const AllowBareDDL: $AllowBareDDL = $.makeType<$AllowBareDDL>(_.spec, "666feb0a-bee5-11ed-acd8-f34e5178215e", _.syntax.literal);
...
const ConnectionTransport: $ConnectionTransport = $.makeType<$ConnectionTransport>(_.spec, "66704c44-bee5-11ed-9927-b5dd83b66d05", _.syntax.literal);
...
const $ConfigObject = $.makeType<$ConfigObject>(_.spec, "6670d22c-bee5-11ed-8086-657409226764", _.syntax.literal);
...
const $AbstractConfig = $.makeType<$AbstractConfig>(_.spec, "669a6d76-bee5-11ed-9916-455bb808d1f1", _.syntax.literal);
...
const $Auth = $.makeType<$Auth>(_.spec, "668eb0b2-bee5-11ed-a266-c11c6e50f6cd", _.syntax.literal);
...
const $AuthMethod = $.makeType<$AuthMethod>(_.spec, "66760a12-bee5-11ed-9032-f30da084d630", _.syntax.literal);
...
const $Config = $.makeType<$Config>(_.spec, "66b98076-bee5-11ed-aab4-01b57b9cac7e", _.syntax.literal);
...
const $DatabaseConfig = $.makeType<$DatabaseConfig>(_.spec, "66efd6e4-bee5-11ed-a4e6-0d293d4abb4c", _.syntax.literal);
...
const $InstanceConfig = $.makeType<$InstanceConfig>(_.spec, "66d4aa22-bee5-11ed-9b54-df9283f3a3cb", _.syntax.literal);
...
const $JWT = $.makeType<$JWT>(_.spec, "6687f970-bee5-11ed-b8ba-233a2d8cd853", _.syntax.literal);
...
const $SCRAM = $.makeType<$SCRAM>(_.spec, "66817f64-bee5-11ed-8dd1-edf21524e0c9", _.syntax.literal);
...
const $Trust = $.makeType<$Trust>(_.spec, "667ba9cc-bee5-11ed-9f2a-abf33b45de6b", _.syntax.literal);
...
function get_config_json(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('cfg::get_config_json', args, _.spec, [
    {args: [], namedArgs: {"sources": {typeId: "603e58f2-bee5-11ed-86fe-c337b108881d", optional: true, setoftype: false, variadic: false}, "max_source": {typeId: "00000000-0000-0000-0000-000000000101", optional: true, setoftype: false, variadic: false}}, returnTypeId: "00000000-0000-0000-0000-00000000010f"},
  ]);
