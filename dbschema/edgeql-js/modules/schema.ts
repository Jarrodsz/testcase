...
const AccessKind: $AccessKind = $.makeType<$AccessKind>(_.spec, "61c2c4ba-bee5-11ed-8220-7d4eed140d5a", _.syntax.literal);
...
const AccessPolicyAction: $AccessPolicyAction = $.makeType<$AccessPolicyAction>(_.spec, "61c2631c-bee5-11ed-9649-c98a5fda7c16", _.syntax.literal);

export type $Cardinality = {
  "One": $.$expr_Literal<$Cardinality>;
  "Many": $.$expr_Literal<$Cardinality>;
} & $.EnumType<"schema::Cardinality", ["One", "Many"]>;
const Cardinality: $Cardinality = $.makeType<$Cardinality>(_.spec, "61bfb96e-bee5-11ed-a982-73053223dd0b", _.syntax.literal);
...
const MigrationGeneratedBy: $MigrationGeneratedBy = $.makeType<$MigrationGeneratedBy>(_.spec, "61c4aafa-bee5-11ed-a820-4b4ec2b6dfd7", _.syntax.literal);
...
const OperatorKind: $OperatorKind = $.makeType<$OperatorKind>(_.spec, "61c0dd6c-bee5-11ed-92e2-31d0244c2d63", _.syntax.literal);
...
const ParameterKind: $ParameterKind = $.makeType<$ParameterKind>(_.spec, "61c19e46-bee5-11ed-bb7e-25ea5e54bb24", _.syntax.literal);
...
const RewriteKind: $RewriteKind = $.makeType<$RewriteKind>(_.spec, "61c44a10-bee5-11ed-9699-0905091f21ed", _.syntax.literal);
...
const SourceDeleteAction: $SourceDeleteAction = $.makeType<$SourceDeleteAction>(_.spec, "61c07b42-bee5-11ed-8fd2-6b8977fd1a6f", _.syntax.literal);
...
const TargetDeleteAction: $TargetDeleteAction = $.makeType<$TargetDeleteAction>(_.spec, "61c01b7a-bee5-11ed-80cb-c38218c1ce85", _.syntax.literal);
...
const TriggerKind: $TriggerKind = $.makeType<$TriggerKind>(_.spec, "61c3865c-bee5-11ed-9fb1-f565039fd4a8", _.syntax.literal);

export type $TriggerScope = {
  "All": $.$expr_Literal<$TriggerScope>;
  "Each": $.$expr_Literal<$TriggerScope>;
} & $.EnumType<"schema::TriggerScope", ["All", "Each"]>;
const TriggerScope: $TriggerScope = $.makeType<$TriggerScope>(_.spec, "61c3e9bc-bee5-11ed-b83f-0d22c9981771", _.syntax.literal);
...
const TriggerTiming: $TriggerTiming = $.makeType<$TriggerTiming>(_.spec, "61c32586-bee5-11ed-8f46-4d2cd4834cf8", _.syntax.literal);
...
const TypeModifier: $TypeModifier = $.makeType<$TypeModifier>(_.spec, "61c1ff6c-bee5-11ed-9ccd-e724878fe4a9", _.syntax.literal);
...
const Volatility: $Volatility = $.makeType<$Volatility>(_.spec, "61c13d02-bee5-11ed-a030-99792296db82", _.syntax.literal);

export type $Object_61c52214bee511ed9ce0e16a8a6c834aλShape = $.typeutil.flatten<_std.$BaseObjectλShape & {
...
type $Object_61c52214bee511ed9ce0e16a8a6c834a = $.ObjectType<"schema::Object", $Object_61c52214bee511ed9ce0e16a8a6c834aλShape, null, [
  ..._std.$BaseObject['__exclusives__'],
]>;
const $Object_61c52214bee511ed9ce0e16a8a6c834a = $.makeType<$Object_61c52214bee511ed9ce0e16a8a6c834a>(_.spec, "61c52214-bee5-11ed-9ce0-e16a8a6c834a", _.syntax.literal);

const Object_61c52214bee511ed9ce0e16a8a6c834a: $.$expr_PathNode<$.TypeSet<$Object_61c52214bee511ed9ce0e16a8a6c834a, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Object_61c52214bee511ed9ce0e16a8a6c834a, $.Cardinality.Many), null);

export type $SubclassableObjectλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
...
type $SubclassableObject = $.ObjectType<"schema::SubclassableObject", $SubclassableObjectλShape, null, [
  ...$Object_61c52214bee511ed9ce0e16a8a6c834a['__exclusives__'],
]>;
const $SubclassableObject = $.makeType<$SubclassableObject>(_.spec, "61cb3aa0-bee5-11ed-bccc-a96e3172004d", _.syntax.literal);
...
const $InheritingObject = $.makeType<$InheritingObject>(_.spec, "62bb5346-bee5-11ed-9035-470b0ac3a78a", _.syntax.literal);
...
export type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
...
const $AnnotationSubject = $.makeType<$AnnotationSubject>(_.spec, "627dce54-bee5-11ed-95cf-a3019397c8f3", _.syntax.literal);
...
const $AccessPolicy = $.makeType<$AccessPolicy>(_.spec, "6365620a-bee5-11ed-8435-1359b7b74138", _.syntax.literal);
...
const $Alias = $.makeType<$Alias>(_.spec, "63b2c0fe-bee5-11ed-ac07-45b2d86b1d44", _.syntax.literal);
...
const $Annotation = $.makeType<$Annotation>(_.spec, "62851182-bee5-11ed-943e-558968ec4359", _.syntax.literal);
...
const $Type = $.makeType<$Type>(_.spec, "61d470d4-bee5-11ed-a9bb-8933c4688c6b", _.syntax.literal);
...
const $PrimitiveType = $.makeType<$PrimitiveType>(_.spec, "61f57266-bee5-11ed-87f9-a385cee5ed0b", _.syntax.literal);
...
const $CollectionType = $.makeType<$CollectionType>(_.spec, "62013e7a-bee5-11ed-9535-5f4bba5ad0c6", _.syntax.literal);
...
const $Array = $.makeType<$Array>(_.spec, "620d7c94-bee5-11ed-9efb-573b328bc055", _.syntax.literal);
...
const $ArrayExprAlias = $.makeType<$ArrayExprAlias>(_.spec, "621cb45c-bee5-11ed-bdf7-bf15c560e9f5", _.syntax.literal);
...
const $CallableObject = $.makeType<$CallableObject>(_.spec, "62d786a6-bee5-11ed-8d74-bd2e9ac467e0", _.syntax.literal);
...
export type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
...
const $VolatilitySubject = $.makeType<$VolatilitySubject>(_.spec, "62e870ba-bee5-11ed-be98-6bb6882a3596", _.syntax.literal);
...
const $Cast = $.makeType<$Cast>(_.spec, "6561a1b8-bee5-11ed-bc84-973db8225c82", _.syntax.literal);

const Cast: $.$expr_PathNode<$.TypeSet<$Cast, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Cast, $.Cardinality.Many), null);

export type $ConsistencySubjectλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & $InheritingObjectλShape & $AnnotationSubjectλShape & {
...
const $ConsistencySubject = $.makeType<$ConsistencySubject>(_.spec, "630f8b14-bee5-11ed-9d26-336fab9748a1", _.syntax.literal);
...
const $Constraint = $.makeType<$Constraint>(_.spec, "62f101bc-bee5-11ed-a66d-6d49d643219d", _.syntax.literal);
...
export type $DeltaλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
...
const $Delta = $.makeType<$Delta>(_.spec, "6274d89e-bee5-11ed-9817-0b455dc2f28a", _.syntax.literal);

const Delta: $.$expr_PathNode<$.TypeSet<$Delta, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Delta, $.Cardinality.Many), null);

export type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
...
const $Extension = $.makeType<$Extension>(_.spec, "65bea444-bee5-11ed-89dd-1b9346cfb021", _.syntax.literal);
...
const $Function = $.makeType<$Function>(_.spec, "6529e926-bee5-11ed-8ce2-b3820fd69e57", _.syntax.literal);
...
export type $FutureBehaviorλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
}>;
type $FutureBehavior = $.ObjectType<"schema::FutureBehavior", $FutureBehaviorλShape, null, [
  ...$Object_61c52214bee511ed9ce0e16a8a6c834a['__exclusives__'],
]>;
const $FutureBehavior = $.makeType<$FutureBehavior>(_.spec, "65d1150c-bee5-11ed-a260-6f4b4a546fbb", _.syntax.literal);
...
const $Global = $.makeType<$Global>(_.spec, "65139ea0-bee5-11ed-a282-57d422b957e9", _.syntax.literal);
...
const $Index = $.makeType<$Index>(_.spec, "631e4802-bee5-11ed-bc00-a9fda88dde58", _.syntax.literal);

const Index: $.$expr_PathNode<$.TypeSet<$Index, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Index, $.Cardinality.Many), null);

export type $PointerλShape = $.typeutil.flatten<$InheritingObjectλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $AnnotationSubjectλShape & {
  "cardinality": $.PropertyDesc<$Cardinality, $.Cardinality.AtMostOne, false, false, false, false>;
  "required": $.PropertyDesc<_std.$bool, $.Cardinality.AtMostOne, false, false, false, false>;
...
const $Pointer = $.makeType<$Pointer>(_.spec, "63463830-bee5-11ed-8c4a-ffba1c88c8a1", _.syntax.literal);

const Pointer: $.$expr_PathNode<$.TypeSet<$Pointer, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Pointer, $.Cardinality.Many), null);

export type $SourceλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
...
const $Source = $.makeType<$Source>(_.spec, "633934aa-bee5-11ed-86e1-01ea89793149", _.syntax.literal);
...
const $Link = $.makeType<$Link>(_.spec, "648be2b2-bee5-11ed-b954-5340704f3aaf", _.syntax.literal);

const Link: $.$expr_PathNode<$.TypeSet<$Link, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Link, $.Cardinality.Many), null);

export type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
...
const $Migration = $.makeType<$Migration>(_.spec, "65a934b0-bee5-11ed-90ae-538bbe0d1d6c", _.syntax.literal);
...
export type $ModuleλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & $AnnotationSubjectλShape & {
}>;
type $Module = $.ObjectType<"schema::Module", $ModuleλShape, null, [
  ...$Object_61c52214bee511ed9ce0e16a8a6c834a['__exclusives__'],
  ...$AnnotationSubject['__exclusives__'],
]>;
const $Module = $.makeType<$Module>(_.spec, "61ef1484-bee5-11ed-8d8d-29c7fd540782", _.syntax.literal);
...
export type $ObjectTypeλShape = $.typeutil.flatten<$InheritingObjectλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $AnnotationSubjectλShape & Omit<$TypeλShape, "<target"> & $SourceλShape & {
  ...
  "<__type__[is std::Object]": $.LinkDesc<_std.$Object_6180590ebee511eda417ff62456c3296, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is std::FreeObject]": $.LinkDesc<_std.$FreeObject, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is schema::Object]": $.LinkDesc<$Object_61c52214bee511ed9ce0e16a8a6c834a, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is AdminPassword]": $.LinkDesc<_default.$AdminPassword, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Admin]": $.LinkDesc<_default.$Admin, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is AdminProfile]": $.LinkDesc<_default.$AdminProfile, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is UserPassword]": $.LinkDesc<_default.$UserPassword, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Answer]": $.LinkDesc<_default.$Answer, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Question]": $.LinkDesc<_default.$Question, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is User]": $.LinkDesc<_default.$User, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Branch]": $.LinkDesc<_default.$Branch, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is UserProfile]": $.LinkDesc<_default.$UserProfile, $.Cardinality.Many, {}, false, false,  false, false>;
...
const $ObjectType = $.makeType<$ObjectType>(_.spec, "63e9dda0-bee5-11ed-a83a-39553602eaab", _.syntax.literal);
...
const $Operator = $.makeType<$Operator>(_.spec, "6546bd94-bee5-11ed-8316-b5f846fecfc2", _.syntax.literal);
...
export type $ParameterλShape = $.typeutil.flatten<$Object_61c52214bee511ed9ce0e16a8a6c834aλShape & {
  "type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
...
const $Parameter = $.makeType<$Parameter>(_.spec, "62cbd45a-bee5-11ed-865d-09425018e17e", _.syntax.literal);
...
const $Property = $.makeType<$Property>(_.spec, "64bcee66-bee5-11ed-b945-f113bf016720", _.syntax.literal);
...
const $PseudoType = $.makeType<$PseudoType>(_.spec, "61ddd3ea-bee5-11ed-8ad9-db97ebd62398", _.syntax.literal);
...
const $Range = $.makeType<$Range>(_.spec, "62559a9c-bee5-11ed-ab9f-850c2ecf4183", _.syntax.literal);
...
const $RangeExprAlias = $.makeType<$RangeExprAlias>(_.spec, "62651f6c-bee5-11ed-a959-4354dc866616", _.syntax.literal);
...
const $Rewrite = $.makeType<$Rewrite>(_.spec, "6394e412-bee5-11ed-b919-9f05fc7d81a9", _.syntax.literal);
...
const $ScalarType = $.makeType<$ScalarType>(_.spec, "63c359e6-bee5-11ed-ae15-f54a1b173902", _.syntax.literal);
...
const $Trigger = $.makeType<$Trigger>(_.spec, "637ce86c-bee5-11ed-ac3a-6da82edb0dac", _.syntax.literal);
...
const $Tuple = $.makeType<$Tuple>(_.spec, "6231a2fe-bee5-11ed-9c08-078fd4313132", _.syntax.literal);
...
const $TupleElement = $.makeType<$TupleElement>(_.spec, "622c093e-bee5-11ed-b569-0110af4a67cc", _.syntax.literal);
...
const $TupleExprAlias = $.makeType<$TupleExprAlias>(_.spec, "6242fb58-bee5-11ed-8849-c9183a3cd9e3", _.syntax.literal);
...
type __defaultExports = {
  ...
  "Object": typeof Object_61c52214bee511ed9ce0e16a8a6c834a;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_61c52214bee511ed9ce0e16a8a6c834a,
